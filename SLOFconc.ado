...
***   we had to load data from multiple datasets, as explained in the a. b. c.,  d. and f. steps
...
*** f. merge with the dataset including data on patients' recovery
